...
def cam1_get():
    ...
    if ( cam1_status == 1 ):
       ...
       # os.system("convert -quality 40 /tmp/camera1-tmp.jpg /tmp/camera1.jpg ")
...
def cam2_get():
    ...
    if ( cam2_status == 1 ):
       ...
       # os.system("convert -quality 40 /tmp/camera2-tmp.jpg /tmp/camera2.jpg ")
...
#@route('/cam/start1', method='GET')
#def cam1_start():
#    global cam1_status
#    cam.start()
#    cam1_status = 1

#@route('/cam/stop1', method='GET')
#def cam1_start():
#    global cam1_status
#    cam.stop()
#    cam1_status = 0
